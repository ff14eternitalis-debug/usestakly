...
export const fr: Dict = {
  ...
  discover: {
    ...
    intentBody:
      "Décris l'outil dont tu as besoin. UseStakly transforme l'intention en topics, puis classe les repos avec le score qualité.",
    intentQueryLabel: "Besoin",
    intentPlaceholder: "ex. ORM TypeScript fiable, outil vidéo formation",
