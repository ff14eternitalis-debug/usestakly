export const en = {
  ...
  landing: {
    ...
    kpi2: "Public formula",
    kpi3: "Black box",
    panelLive: "Live repository",
    panelSample: "from Discover",
  ...
  discover: {
    ...
    recommendedTabHint: "Describe your need and get a ranked shortlist.",
    radarTab: "Emerging radar",
    radarTabHint: "See young or rising projects to inspect before adoption.",
    radarTitle: "Emerging projects to inspect",
    radarBody:
      "This mode highlights repos with a rising signal or young maturity. The quality score stays visible so novelty is not mistaken for reliability.",
    radarEmpty: "No emerging project in the current corpus.",
    advancedTab: "Advanced explorer",
    advancedTabHint: "Search, filters, topics, score and manual sorting.",
    queryLabel: "Query",
  ...
  account: {
    ...
    notificationChannelsTitle: "Choose where watch alerts land",
    notificationChannelsIntro:
      "In-app notifications stay active. Add an email or Discord webhook when you want critical drift to reach you outside the browser.",
    emailChannelTitle: "Email",
    emailChannelBody:
      "Use a dedicated inbox for critical alerts and future digests.",
    emailChannelLabel: "Notification email",
    emailChannelPlaceholder: "dev@example.com",
    discordChannelTitle: "Discord webhook",
    discordChannelBody:
      "Create a Discord webhook in the target channel, then paste its URL here. The full URL is never shown again.",
    discordWebhookLabel: "Webhook URL",
    discordWebhookPlaceholder: "https://discord.com/api/webhooks/...",
    criticalAlerts: "Critical alerts",
    dailyDigest: "Daily digest",
    digestTimeLabel: "Digest time",
    digestMorning: "Morning",
    digestNoon: "Noon",
    digestEvening: "End of day",
    digestNight: "Evening",
    timezoneLabel: "Timezone",
    saveEmailChannel: "Save email",
    saveWebhookChannel: "Save webhook",
    saveNotificationPreferences: "Save digest time",
    savingChannel: "Saving…",
    testChannel: "send test",
    testingChannel: "sending…",
    deleteChannel: "remove",
    deletingChannel: "removing…",
