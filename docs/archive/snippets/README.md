...
Le produit vivant est désormais :

- discovery de repos GitHub OSS scorés
- watchlist et notifications
- MCP orienté registry GitHub

Pour le produit courant, revenir vers :

- [docs/README.md](../../README.md)
- [TODO.md](../../../TODO.md)
- [strategy-pivot-2026-04-21.md](../../strategy-pivot-2026-04-21.md)
